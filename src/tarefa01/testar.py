...
class Task(BaseTask):
    def teste_1_megasena(self):
        binary = self.compile(["megasena.c"])
        self.test_cases(binary, self.case_range("megasena{}.in", 1, 5))

    def teste_2_megasena(self):
        binary = self.compile(["megasena.c"])
        self.test_cases(binary, self.case_range("megasena{}.in", 6, 15))
